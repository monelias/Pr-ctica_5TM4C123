...
extern void Configurar_PLL_E1(void)
{
  ...
  //SYSCTL->RCC2 = (SYSCTL->RCC2&~ 0x1FC00000)  // Exper1 clear system clock divider
                //  + (_50MHZ<<22);      // configure for 50 MHz clock
  SYSCTL->RCC2 = (SYSCTL->RCC2&~ 0x1FC00000)  // Exper2 clear system clock divider
                  + (_20MHZ<<22);      // configure for 20 MHz clock
